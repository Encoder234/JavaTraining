...
public class BankAccountService {
	...
	public void createAccount(String accountNumber, String ownerName, double initialBalance)
		...
		if (initialBalance < MINIMUM_INITIAL_BALANCE) {
			...
			throw new InvalidAccountException (String.format("Provided initial balance of %f is less than the accepted minimum balance of %s", initialBalance, MINIMUM_INITIAL_BALANCE));
	...
	public void transfer(String fromAccountNumber, String toAccountNumber, double amount)
		...
		if (fromAccount.getBalance() < amount) {
			...
			throw new InsufficientFundsException(String.format("Insufficient funds current balance is %.2f, requested amount is %.2f",fromAccount.getBalance(), amount));
